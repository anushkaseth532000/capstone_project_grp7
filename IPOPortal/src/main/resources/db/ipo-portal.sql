...
--
-- Host: localhost
-- Generation Time: Aug 27, 2023 at 08:37 AM
...
CREATE TABLE IF NOT EXISTS `merchant_details` (
  ...
  `Nodal_Account_No` varchar(16) NOT NULL,
  `Pool_Account_No` varchar(16) DEFAULT NULL,
  `Pool_IFSC_Code` varchar(11) DEFAULT NULL,
...
(7, 2, 8, 'gowrinse', 'gowrinse', 'gowrinse', 'gowrinse', 'gowrinse', '607002', '', '', 'gowrinse', '', 'gowrinse', 'gowrinse', 'gowrinse', 'gowrinse@axisbank', 'test23132321321', 'gowrinse', '', '', '', 'gowrinse', 'gowrinse', '', '', '', 'Uploaded', NULL, '2023-08-20 00:00:00'),
(6, 2, 7, 'sakshinse', 'sakshinse', 'sakshinse', 'sakshinse', 'sakshinse', '607002', '', '', 'sakshinse', '', 'sakshinse', 'sakshinse', 'sakshinse', 'sakshinse@axisbank', 'sakshinse', 'kiruba', '', '', '', 'sakshinse', 'sakshinse', '', '', '', 'Uploaded', NULL, '2023-08-20 00:00:00'),
(8, 2, 9, 'test', 'test', 'test', 'test', 'test', 'test', '', '', 'test', 'gdf', 'test', 'test', 'test', 'kirubanse@axisbank', 'test', 'test', 'test', 'test', 'test', 'testrerttrt', '213321123321123', '213321123321123', 'testghgghgg', '321321sdfsd', 'Uploaded', NULL, '2023-08-27 00:00:00');
...
(5, 2, '-', '-', 'Uploaded By Merchant Creation Form', 1, '2023-08-20 00:00:00'),
(6, 2, '-', '-', 'Uploaded By Merchant Creation Form', 1, '2023-08-20 00:00:00'),
(7, 2, '-', '-', 'Uploaded By Merchant Creation Form', 1, '2023-08-20 00:00:00'),
(8, 2, '-', '-', 'Uploaded By Merchant Creation Form', 1, '2023-08-20 00:00:00'),
(9, 2, '-', '-', 'Uploaded By Merchant Creation Form', 1, '2023-08-27 00:00:00');
